...
- COMANDO PER ESECUZIONE (ATTENZIONE -> è necessario eseguire la prima riga di pre-requisiti ogni volta che si chiude il terminale):
    ...
    - Intero dataset
        ...
        python3 prompting/evaluate_ollama_rag.py --sessions /media/matteo/T9/outputMerge/cowrie_TEST.jsonl --index-file /media/matteo/T9/outputMerge/cowrie_TRAIN.jsonl --persist-dir /media/matteo/T9/DB_vettoriale --output output/prova/gemini_rag_results_n10_ctx5_k5.jsonl --k 5 --rag-k 3 --context-len 5 --n 10
