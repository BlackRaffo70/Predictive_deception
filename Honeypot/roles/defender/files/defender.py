...
DEFENSE_ARTIFACTS_DIR = os.path.join(OUT_DIR, "defense_artifacts") # Cartella contiene i file di difesa generati dal LLM
os.makedirs(os.path.join(OUT_DIR, "runtime"), exist_ok=True) 
os.makedirs(os.path.join(OUT_DIR, "defense_artifacts"), exist_ok=True)
...
def plan_and_apply_defenses(session_key: str, predictions: List[str]):
    ...
    # In entrambi i casi, la difesa viene prodotta e inserita nella cartella /defense_artifacts
